...
class BigIpRest(BigIpCommon):
    def __init__(self, module):
        ...
        self._uri = 'https://%s/mgmt/tm/asm/policies/%s' % (self._hostname, self._policyId)
        self._headers = {
    ...
    def read(self):
        changed = False
	myVS = "/" + self._partition + "/" + self._virtual
        ...
        if resp.status_code == 200:
	    	...
	    	virtualServers = res["virtualServers"]
		if myVS in virtualServers:
			return False
		else:
